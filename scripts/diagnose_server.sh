...
echo "== listening =="; ss -lntp | grep -E ":${PORT}|:8100|:80[[:space:]]|:8090" || true
echo "== files ==";
...
echo "== health 8090 =="; curl -sv --max-time 5 "http://127.0.0.1:${PORT}/health" || true
echo "== health 80 =="; curl -sv --max-time 5 "http://127.0.0.1/health" || true
