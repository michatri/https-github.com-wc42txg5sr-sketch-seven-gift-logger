...
ในหน้าเว็บมีเมนู:
- **ลงทะเบียนใบหน้า** — เพิ่ม/แก้ไข/ลบรายชื่อ พร้อมปีการศึกษา เทอม ชั้น ห้อง
- **ประวัตินักเรียน** — ค้นหา/กรองตามปี เทอม ชั้น ห้อง และดูประวัติเข้า-ออก
- **ลงเวลาเข้าโรงเรียน** — สแกนใบหน้าจากกล้องแล้วบันทึกเข้า
- **ลงเวลาออกจากโรงเรียน** — สแกนใบหน้าจากกล้องแล้วบันทึกออก
